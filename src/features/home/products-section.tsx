    ...
    <section className="bg-bg-base py-24 lg:py-32">
      <Container>
        <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
          ...
          <p className="max-w-[570px] text-lg leading-[1.65] text-text-secondary md:pt-2">
            Explore our latest pre-engineered steel buildings delivered across
            India — from warehouses to industrial plants.
          </p>
        </div>
