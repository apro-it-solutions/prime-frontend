      ...
      <Container>
        <div className="overflow-hidden rounded-[28px] bg-text-primary">
          <div className="flex flex-col xl:flex-row xl:items-stretch">
            {/* Building image */}
            <div className="relative h-64 w-full shrink-0 sm:h-80 xl:h-[460px] xl:w-[560px] 2xl:h-[538px] 2xl:w-[800px]">
              <Image
                src={ctaBuilding}
            ...
            {/* Copy */}
            <div className="flex flex-1 flex-col items-start justify-center gap-5 px-8 py-12 xl:px-[60px]">
