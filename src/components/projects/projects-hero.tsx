...
/**
 * 01 — Projects Hero. Fixed-height (720px desktop) aerial banner with the shared
 * header overlaid and the page headline anchored bottom-left.
 */
  ...
  return (
    <section className="relative flex min-h-[520px] w-full flex-col overflow-hidden bg-[#111] lg:h-[720px] lg:min-h-0">
      ...
      <Container className="relative z-10 flex flex-1 flex-col justify-end pb-14 pt-40 lg:pb-[92px]">
        <h1 className="max-w-[760px] font-display text-[2.5rem] font-semibold leading-[1.15] tracking-[-0.72px] text-white sm:text-6xl lg:text-[72px]">
          Structures we&apos;ve delivered across India.
        </h1>
      </Container>
    </section>
  );
